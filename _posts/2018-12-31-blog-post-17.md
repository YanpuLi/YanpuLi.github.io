...
{% capture notice-2 %}
**Answer:** how SG make predictions on multiple context words using the same <img src="https://latex.codecogs.com/svg.latex?  \vec{u}" >. Using softmax, this vector will be changed into .
{% endcapture %}
