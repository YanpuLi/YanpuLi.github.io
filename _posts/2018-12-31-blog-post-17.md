...
{% capture notice-2 %}
**Answer to how SG make predictions on multiple context words using the same <p float="left"><img src="https://latex.codecogs.com/svg.latex?  \vec{u}" title="p" /></p>:** Using softmax, this vector will be changed into .
{% endcapture %}
