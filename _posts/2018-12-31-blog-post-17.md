...
- Input: Words need to be firstly changed into BoW to pass onto the model. 
- 1st transformation: a V\*N matrix W,
- 2nd transformation: a N\*V matrix W',
- Final step before generating output: softmax
