...
Again set the derivatives with respect to w, b, ξ<sub>n</sub> to 0, then we get, and obtain the new form of Lagrangian:
<p float="left"><img src="/images/svm_formula12.png" width="220" /></p> 
<p float="left"><img src="/images/svm_formula13.png" width="420" /></p> 
