...
**Odds Ratio, OR**: is the ratio of odds vs odds.
...
When the base morbidity rate is very small, and <img src="https://latex.codecogs.com/svg.latex? \pi_{11} << pi_{22}" title="p" />, RR is approaching OR.
