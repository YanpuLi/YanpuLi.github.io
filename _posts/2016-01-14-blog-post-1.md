...
* Constructing training set for meta learner
  * creating training data over D<sub>i</sub>: the output predicted labels from level-0 are kept as new features; thus, at the end of this stage, it will contain T attributes, and keep the original class labels as labels in new data
* Level-1
  * meta model generation
* Regenerate base learners on the whole dataset D, 
