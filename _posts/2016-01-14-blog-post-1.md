...
* Level-0
  * Input: for each base learner, use (D - ith subset) as training set and ith subset as testing set;
  * base model generation
* Constructing input for meta learner
  * creating training data over the ith subset: the output predicted labels from level-0 are kept as new features; thus, at the end of this stage, it will contain T attributes, and keep the original class labels as labels in new data;
* Level-1
