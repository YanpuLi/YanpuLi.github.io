...
1. Odds v.s. Odds Ratio:
	* Odds = probability of event / probablity of non-event. 

	So if odds = 3, then the probability of having that event is twice higher than that event won't happen. 
	* Odds ratio = Odds / Odds. 

	This term explains the risk ratio of having an event vs not.
