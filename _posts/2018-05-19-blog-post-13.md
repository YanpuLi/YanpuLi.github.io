...
It's mentioned above, blocks can be distributed in disk, which will increase the time in doing disk I/O reading. XGB has applies two tricks to improve this out-of-core computation.
