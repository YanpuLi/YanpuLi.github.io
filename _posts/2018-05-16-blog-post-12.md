...
Tree is one of the most widely used model, with multiple variations(regression tree, classification tree, bagging: RF, boosting: GBDT). This series of posts will start from giving a brief introduction of the most 
