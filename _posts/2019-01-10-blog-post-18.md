...
1. encoders learn level-wise intermediate representations from bottom to top,

<img src="https://latex.codecogs.com/svg.latex?  h_{i+1} = E_{i}(h_{i}) " >

2. independent training of each G, 

<img src="https://latex.codecogs.com/svg.latex?  \widehat{h_{i}} = G_{i}(h_{i+1}, z_{i}) " >

3. jointly end-to-end training of all Gs,
...
E<sub>i</sub>: the ith encoder
G<sub>i</sub>: the ith generator
D<sub>i</sub>: the ith discriminator
```
<p float="left">
