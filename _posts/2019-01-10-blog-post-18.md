...
- By extracting information from images layer by layer(x-> h<sub>1</sub>-> ...-> h<sub>i</sub>->... -> y), the details have also been obtained. The adversarial loss enforces SGAN simulated intermediate representations are within the corresponding representation's manifold(In other words, adversarial loss ensures SGAN generated representations close to encoders' generated representations).
