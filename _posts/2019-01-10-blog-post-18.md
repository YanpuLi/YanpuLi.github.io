...
| ------------- |:-------------:| -----:| ------------:|
| encoders learn level-wise intermediate representations from bottom to top | ![](/images/SGANf1.png)| adversarial loss: <img src="https://latex.codecogs.com/svg.latex?  L_{G_{i}}^{adv}(h_{i}, \widehat{h_{i}})">|discriminator identify real data and generated ones, I would also regard this section as ensuring <img src="https://latex.codecogs.com/svg.latex?  \widehat{h_{i}}"> close to h<sub>i</sub> |
