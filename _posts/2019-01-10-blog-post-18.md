...
| **Testing Step**        | **Formula Details**    |**Loss Function**  | **Why Using This Loss Function**  |
| ------------- |:-------------:| -----:| ------------:|
| Top-to-bottom generating simulated images, no info. needed from encoder||||
...
**Figure 3. SGAN Framework Details(Source: [1])**
