...
The problem becomes:w
<script type="text/javascript" async
  src="https://cdn.mathjax.org/mathjax/latest/MathJax.js?config=TeX-MML-AM_CHTML">
</script>
<a href="https://www.codecogs.com/eqnedit.php?latex=p^*&space;=&space;{min_{w,b}}&space;{\theta&space;(w)}&space;=&space;{min_{w,b}}&space;max_{{\alpha}_i&space;>0}&space;{\mathcal&space;{L}(w,&space;b,&space;\alpha)}" target="_blank"><img src="https://latex.codecogs.com/gif.latex?p^*&space;=&space;{min_{w,b}}&space;{\theta&space;(w)}&space;=&space;{min_{w,b}}&space;max_{{\alpha}_i&space;>0}&space;{\mathcal&space;{L}(w,&space;b,&space;\alpha)}" title="p^* = {min_{w,b}} {\theta (w)} = {min_{w,b}} max_{{\alpha}_i >0} {\mathcal {L}(w, b, \alpha)}" /></a>
